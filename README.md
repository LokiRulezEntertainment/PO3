# [RLCraft 1.12.2 - Release v2.9.3](https://www.curseforge.com/minecraft/modpacks/rlcraft) on Curseforge
...
The docker on first run will download the same version as tagged of RLCraft 1.12.2 - Release v2.9.3 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "RLCraft 1.12.2 - Release v2.9.3 Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-rlcraft

Docker: https://hub.docker.com/repository/docker/goobaroo/rlcraft